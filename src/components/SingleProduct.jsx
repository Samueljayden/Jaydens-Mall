...
const SingleProduct = () => {
    ...
    const submitForm = async (e) => {
        ...
        setError("");
        setSuccess("");
        setLoading("Please wait... Processind payment....");
        try {
            const data = new FormData();
            data.append("amount", product.product_cost);
            data.append("phone", phone);

            const response = await axios.post("https://Samuelgreg.pythonanywhere.com/api/mpesa_payment", data);
            setLoading("");
    ...
    return (
        <div className="row justify-content-center mt-4">
            ...
            <div className="col-md-3 card shaddow">
